 ...
 */
package com.college.userlatlong.service;
...
import com.college.userlatlong.utils.SharedPreferenceUtil
import com.college.userlatlong.utils.toText
...
class ForegroundOnlyLocationService : Service() {
    ...
    private var TAG: String = "ForgroundLocation"
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                if (sharedPreference.getValueString("UserId") != null) {
                    userId = sharedPreference.getValueString("UserId")!!
                }
                val sdf = SimpleDateFormat("ddMMyyyy")
                val currentDate = sdf.format(Date())
                val sdf1 = SimpleDateFormat("dd/MM/yyyy")

                AES256.SecretKey = AES256.SecretKey + currentDate;
                var upload = Upload(
                    AES256.getInstance().encrypt(currentLocation?.latitude.toString().trim()),
                    AES256.getInstance().encrypt(currentLocation?.longitude.toString().trim()),
                ...
                repo?.uploadData(user = upload)?.enqueue(object : Callback<User> {
                ...
                Log.e(
                    "Location",
                    "lat = ${currentLocation?.latitude} and long = ${currentLocation?.longitude}"
                )
